module github.com/othmanhaba/nixway-core/apps/worker

go 1.25.0

require github.com/othmanhaba/nixway-core/internal v0.0.0
...
replace github.com/othmanhaba/nixway-core/internal => ../../internal
