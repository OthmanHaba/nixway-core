...
const file_agent_v1_agent_proto_rawDesc = "" +
	...
	"\x0eca_certificate\x18\x03 \x01(\fR\rcaCertificate\"\xe9\x0e\n" +
	"\fAgentMessage\x123\n" +
	...
	"\rvolume_result\x18\x19 \x01(\v2\x16.agent.v1.VolumeResultH\x00R\fvolumeResultB\t\n" +
	"\apayload\"\xea\x0e\n" +
	...
	"\rvolume_resize\x18\x1a \x01(\v2\x1d.agent.v1.VolumeResizeCommandH\x00R\fvolumeResizeB\t\n" +
	"\apayload\"`\n" +
	"\tHeartbeat\x12\x19\n" +
	...
	"\thost_path\x18\x03 \x01(\tR\bhostPath\"n\n" +
	...
	"\rsnapshot_path\x18\a \x01(\tR\fsnapshotPath2\x92\x01\n" +
	"\fAgentService\x12?\n" +
...
var file_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_agent_v1_agent_proto_goTypes = []any{
	...
	nil,                                // 64: agent.v1.ExecCommand.EnvEntry
	nil,                                // 65: agent.v1.ContainerMetric.LabelsEntry
	nil,                                // 66: agent.v1.BuildCommand.BuildArgsEntry
	nil,                                // 67: agent.v1.DeployCommand.EnvEntry
	nil,                                // 68: agent.v1.DeployCommand.LabelsEntry
	nil,                                // 69: agent.v1.ContainerInspectResult.EnvEntry
	nil,                                // 70: agent.v1.ContainerInspectResult.LabelsEntry
...
var file_agent_v1_agent_proto_depIdxs = []int32{
	...
	6,  // 25: agent.v1.ControlMessage.exec_command:type_name -> agent.v1.ExecCommand
	13, // 26: agent.v1.ControlMessage.file_transfer:type_name -> agent.v1.FileTransferRequest
	14, // 27: agent.v1.ControlMessage.cert_rotation:type_name -> agent.v1.CertRotation
	17, // 28: agent.v1.ControlMessage.provision_command:type_name -> agent.v1.ProvisionCommand
	19, // 29: agent.v1.ControlMessage.ssh_key_install:type_name -> agent.v1.SSHKeyInstallCommand
	21, // 30: agent.v1.ControlMessage.wireguard_keygen:type_name -> agent.v1.WireGuardKeyGenCommand
	23, // 31: agent.v1.ControlMessage.wireguard_apply:type_name -> agent.v1.WireGuardApplyCommand
	25, // 32: agent.v1.ControlMessage.wireguard_teardown:type_name -> agent.v1.WireGuardTeardownCommand
	29, // 33: agent.v1.ControlMessage.dns_update_hosts:type_name -> agent.v1.DNSUpdateHostsCommand
	31, // 34: agent.v1.ControlMessage.build_command:type_name -> agent.v1.BuildCommand
	33, // 35: agent.v1.ControlMessage.deploy_command:type_name -> agent.v1.DeployCommand
	41, // 36: agent.v1.ControlMessage.stop_container:type_name -> agent.v1.StopContainerCommand
	45, // 37: agent.v1.ControlMessage.image_pull:type_name -> agent.v1.ImagePullCommand
	43, // 38: agent.v1.ControlMessage.container_logs:type_name -> agent.v1.ContainerLogsCommand
	47, // 39: agent.v1.ControlMessage.container_exec:type_name -> agent.v1.ContainerExecCommand
	48, // 40: agent.v1.ControlMessage.container_exec_input:type_name -> agent.v1.ContainerExecInput
	50, // 41: agent.v1.ControlMessage.restart_container:type_name -> agent.v1.RestartContainerCommand
	52, // 42: agent.v1.ControlMessage.container_inspect:type_name -> agent.v1.ContainerInspectCommand
	54, // 43: agent.v1.ControlMessage.server_logs:type_name -> agent.v1.ServerLogsCommand
	56, // 44: agent.v1.ControlMessage.server_cleanup:type_name -> agent.v1.ServerCleanupCommand
	37, // 45: agent.v1.ControlMessage.traffic_route:type_name -> agent.v1.TrafficRouteCommand
	58, // 46: agent.v1.ControlMessage.volume_create:type_name -> agent.v1.VolumeCreateCommand
	59, // 47: agent.v1.ControlMessage.volume_delete:type_name -> agent.v1.VolumeDeleteCommand
	60, // 48: agent.v1.ControlMessage.volume_move:type_name -> agent.v1.VolumeMoveCommand
	61, // 49: agent.v1.ControlMessage.volume_snapshot:type_name -> agent.v1.VolumeSnapshotCommand
	62, // 50: agent.v1.ControlMessage.volume_resize:type_name -> agent.v1.VolumeResizeCommand
	71, // 51: agent.v1.Heartbeat.timestamp:type_name -> google.protobuf.Timestamp
	64, // 52: agent.v1.ExecCommand.env:type_name -> agent.v1.ExecCommand.EnvEntry
	11, // 53: agent.v1.HealthReport.disks:type_name -> agent.v1.DiskInfo
	10, // 54: agent.v1.MetricReport.containers:type_name -> agent.v1.ContainerMetric
	65, // 55: agent.v1.ContainerMetric.labels:type_name -> agent.v1.ContainerMetric.LabelsEntry
	0,  // 56: agent.v1.FileTransferRequest.direction:type_name -> agent.v1.FileTransferRequest.Direction
	11, // 57: agent.v1.ResourceReport.disks:type_name -> agent.v1.DiskInfo
	15, // 58: agent.v1.ResourceReport.network_interfaces:type_name -> agent.v1.NetworkInterface
	28, // 59: agent.v1.MeshHealthReport.peers:type_name -> agent.v1.PeerHealthInfo
	66, // 60: agent.v1.BuildCommand.build_args:type_name -> agent.v1.BuildCommand.BuildArgsEntry
	67, // 61: agent.v1.DeployCommand.env:type_name -> agent.v1.DeployCommand.EnvEntry
	36, // 62: agent.v1.DeployCommand.traefik:type_name -> agent.v1.TraefikConfig
	68, // 63: agent.v1.DeployCommand.labels:type_name -> agent.v1.DeployCommand.LabelsEntry
	34, // 64: agent.v1.DeployCommand.volume_mounts:type_name -> agent.v1.VolumeMount
	35, // 65: agent.v1.DeployCommand.exec_health_check:type_name -> agent.v1.HealthCheckSpec
	38, // 66: agent.v1.TrafficRouteCommand.groups:type_name -> agent.v1.TrafficBackendGroup
	69, // 67: agent.v1.ContainerInspectResult.env:type_name -> agent.v1.ContainerInspectResult.EnvEntry
	70, // 68: agent.v1.ContainerInspectResult.labels:type_name -> agent.v1.ContainerInspectResult.LabelsEntry
	3,  // 69: agent.v1.AgentService.Connect:input_type -> agent.v1.AgentMessage
	1,  // 70: agent.v1.AgentService.Register:input_type -> agent.v1.RegisterRequest
	4,  // 71: agent.v1.AgentService.Connect:output_type -> agent.v1.ControlMessage
	2,  // 72: agent.v1.AgentService.Register:output_type -> agent.v1.RegisterResponse
